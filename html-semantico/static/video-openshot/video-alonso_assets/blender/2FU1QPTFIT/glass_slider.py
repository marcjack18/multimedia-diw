...
params_json = r"""{"file_name": "TitleFileName", "Alongtimeago": "A long time ago in a video\neditor far, far away...", "TitleSpaceMovie": "open\nshot", "Episode": "Episode IV", "EpisodeTitle": "A NEW OPENSHOT", "MainText": "It is a period of software war. Free software developers have won some battles with free, and open-source applications. They leave the source code available for everybody in the Galaxy, allowing people to access software knowledge and truth.\n\nBut the EULA Galactic Empire is not dead and prepares its revenge with an ultimate weapon: the blue screen of DEATH. This armored system can anihilate an entire device by a simple segfault.\n\nBut the rebel hackers have a secret weapon too: an atomic penguin which protects them from almost all digital injuries...", "start_frame": 1, "end_frame": 180, "length_multiplier": 1.0, "title1": "Titulo 1", "extrude": 0.0, "bevel_depth": 0.02, "fontname": "Bfont", "text_size": 1.0, "start_x": -2.4, "start_z": 0.6, "width": 1.0, "diffuse_color": [1.0, 1.0, 1.0, 1.0], "specular_color": [1.0, 1.0, 1.0], "specular_intensity": 1.0, "diffuse_color_bg": [0.8745098039215686, 0.8627450980392157, 0.9058823529411765, 1.0], "specular_color_bg": [1.0, 1.0, 1.0], "specular_intensity_bg": 1.0, "alpha_bg": 0.733, "fps": 30, "resolution_x": 1280, "resolution_y": 720, "resolution_percentage": 50, "quality": 100, "file_format": "PNG", "color_mode": "RGBA", "alpha_mode": 1, "horizon_color": [0.57, 0.57, 0.57], "animation": true, "output_path": "C:\\Users\\Usuario\\.openshot_qt\\blender\\2FU1QPTFIT\\TitleFileName"}"""
